...
def main():
	...
	# creating stage
	canvas.create_line((-68.4000+224), (0.0000+108.8),(68.4+224),(0+108.8), fill="green", width=10)
	#top platfrom
	canvas.create_line(-18.8+224, -54.40+108.8, 18.8+224, -54.40+108.8, fill = 'green', width = 5      )
	#left side plat
	canvas.create_line(-57.60+224, -27.20+108.8, -20+224, - 27.20+108.8, fill = 'green', width = 5      )
	#ride side plat
	canvas.create_line(20+224, -27.20+108.8, 57.6+224, - 27.20+108.8, fill = 'green', width = 5      )
